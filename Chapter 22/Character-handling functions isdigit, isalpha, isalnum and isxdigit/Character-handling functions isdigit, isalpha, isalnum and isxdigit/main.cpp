...
//
//  Created by ben haywood on 5/6/20.
//  Copyright © 2020 ben haywood. All rights reserved.
//

#include <iostream>
#include <cctype> // character-handeling function prototypes
using namespace std;

int main(int argc, const char * argv[]) {
    // insert code here...
    cout << "According is isdigit:\n"
    ...
    << (isxdigit('f') ? "f is a" : "$ is not a") << "hexadecimal digit" << endl;
    return 0;
}
